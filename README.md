...
In order to run the example DynamicContinuousApplicationWithSpark, it is necessary to run first CounterProvider class whose goal is to store in a file the data that is read by Spark   
## Requirements
