...
import org.uma.jmetalsp.spark.streamingdatasource.SimpleSparkStructuredKafkaStreamingCounter;
 ...
 */
public class DynamicContinuousApplicationWithSparkKafka {
  ...
  public static void main(String[] args) throws IOException, InterruptedException {
    ...
    SimpleSparkStructuredKafkaStreamingCounter streamingDataSource =
            new SimpleSparkStructuredKafkaStreamingCounter(kafkaParams,topic) ;
