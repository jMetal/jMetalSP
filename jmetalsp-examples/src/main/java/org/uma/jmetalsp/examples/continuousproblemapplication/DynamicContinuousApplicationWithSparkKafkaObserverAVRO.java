...
public class DynamicContinuousApplicationWithSparkKafkaObserverAVRO {
  ...
  public static void main(String[] args) throws IOException, InterruptedException {
    ...
    Observable<AlgorithmData> observable = new KafkaObservable<>("algorithmdata","avsc/AlgorithmData.avsc");
    ...
    KafkaBasedConsumer<AlgorithmData> chartKafkaBasedConsumer =
            new KafkaBasedConsumer<>("algorithmdata", chartConsumer, new AlgorithmData(),"avsc/AlgorithmData.avsc") ;
