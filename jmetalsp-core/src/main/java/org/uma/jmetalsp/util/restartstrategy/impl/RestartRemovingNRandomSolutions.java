 ...
 */
public class RestartRemovingNRandomSolutions<S extends Solution<?>> implements RestartStrategy<S> {
  private int percentageOfSolutionsToRemove;

  public RestartRemovingNRandomSolutions(int percentageOfSolutionsToRemove) {
