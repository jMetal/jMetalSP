...
public class FDA5 extends FDA implements Serializable {
  ...
  public FDA5(Observable<TimeObservedData> observable){
    this(12,3, observable);
  }

  public FDA5(Integer numberOfVariables, Integer numberOfObjectives, Observable<TimeObservedData> observable) throws JMetalException {
	  super(observable) ;
