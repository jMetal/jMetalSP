...
public class FDA1 extends FDA implements Serializable {
  ...
  public FDA1(Observable<ObservedIntegerValue> observable){
  ...
  public FDA1 (Integer numberOfVariables, Integer numberOfObjectives, Observable<ObservedIntegerValue> observer) throws JMetalException {
  	super(observer) ;
