...
public class FDA4 extends FDA implements Serializable {
  ...
  public FDA4(Observable<TimeObservedData> observable){
    this(12,3, observable);
  }

  public FDA4(Integer numberOfVariables, Integer numberOfObjectives, Observable<TimeObservedData> observable) throws JMetalException {
    super(observable) ;
